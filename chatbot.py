...
class Ui_main(object):
    def setupUi(self, main):
        ...
        main.resize(504, 500)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/1200px-Facebook_Messenger_logo_2013.svg.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("images/chat.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
